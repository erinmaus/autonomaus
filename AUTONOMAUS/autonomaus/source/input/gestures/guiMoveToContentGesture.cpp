...
const std::size_t autonomaus::GUIMoveToContentGesture::MIN_PATHS = 10;
const float autonomaus::GUIMoveToContentGesture::DRIFT_THRESHOLD = 16.0f;
const float autonomaus::GUIMoveToContentGesture::LENGTH_THRESHOLD = 0.25f;

autonomaus::GUIMoveToContentGesture::GUIMoveToContentGesture(
...
int autonomaus::GUIMoveToContentGesture::try_find_path(
...
int autonomaus::GUIMoveToContentGesture::play()
{
	int result;
	...
	if (this->speed_multiplier != 1.0f)
	{
		path.time(this->speed_multiplier);
	}

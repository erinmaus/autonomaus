...
#ifndef CHOMSKY_GUI_GPD_SIZE_MATCH_STATEMENT_NODE_HPP
#define CHOMSKY_GUI_GPD_SIZE_MATCH_STATEMENT_NODE_HPP
...
namespace chomsky { namespace gpd
{
	...
	class SizeMatchStatementNode : public Node
	{
	public:
		SizeMatchStatementNode() = default;
		~SizeMatchStatementNode() = default;

...
chomsky::TerrainElevationWorldUpdatePass::TerrainElevationWorldUpdatePass(
...
void chomsky::TerrainElevationWorldUpdatePass::draw_terrain(
	...
	const kompvter::ModelDrawEvent& event)
{
	...
	auto terrain_sector = thoreau::sector_from_world(translation);

...
chomsky::StaticMaterialSetMatchExecutor::StaticMaterialSetMatchExecutor(
...
bool chomsky::StaticMaterialSetMatchExecutor::execute(
	const thoreau::TileCoordinate& location,
	const MaterialSetMatch& match) const
{
	auto material_state = this->static_block->get_materials_state();

...
continent7::Application::CandidateQueryWindow::CandidateQueryWindow(
...
void continent7::Application::CandidateQueryWindow::update(float delta)
{
	this->thumbnail_time += delta;
}

void continent7::Application::CandidateQueryWindow::open(
...
std::string continent7::Application::CandidateQueryWindow::get_title() const
{
	return "Candidate Query";
}

void continent7::Application::CandidateQueryWindow::update_gui()
{
	...
	auto current = candidate_manager.space_begin(this->tile_coordinate);
	auto end = candidate_manager.space_end(this->tile_coordinate);
	while (current != end)
	{
		auto tag = current->second;
...
void continent7::Application::CandidateQueryWindow::preview_candidate(
	int tag)
{
...
void continent7::Application::CandidateQueryWindow::show_candidate()
{

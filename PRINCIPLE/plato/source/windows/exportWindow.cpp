...
plato::Application::ExportWindow::ExportWindow(Application* application) :
	principle::Window(application)
{
	this->application = application;
}

std::string plato::Application::ExportWindow::get_title() const
{
	return "Export Map";
}

void plato::Application::ExportWindow::open()
{
...
void plato::Application::ExportWindow::update_gui()
{
...
void plato::Application::ExportWindow::export_map()
{
